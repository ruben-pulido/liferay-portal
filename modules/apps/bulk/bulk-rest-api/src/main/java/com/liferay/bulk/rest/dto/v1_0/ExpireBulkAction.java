 ...
 */
@Generated("")
@GraphQLName("ExpireBulkAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ExpireBulkAction")
public class ExpireBulkAction extends BulkAction implements Serializable {

	public static ExpireBulkAction toDTO(String json) {
		return ObjectMapperUtil.readValue(ExpireBulkAction.class, json);
	}

	public static ExpireBulkAction unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ExpireBulkAction.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.ExpireBulkAction",
		name = "x-class-name"
	)
