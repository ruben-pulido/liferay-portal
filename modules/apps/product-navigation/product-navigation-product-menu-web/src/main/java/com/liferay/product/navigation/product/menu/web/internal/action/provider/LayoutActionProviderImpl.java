...
package com.liferay.product.navigation.product.menu.web.internal.action.provider;
 ...
 * @author Rubén Pulido
 */
public class LayoutActionProviderImpl implements LayoutActionProvider {

	public LayoutActionProviderImpl(
	...
	public JSONArray getActionsJSONArray(Layout layout) throws Exception {
		...
		if (!layout.isTypeCollection() &&
			...
			itemsJSONArray.put(
				JSONUtil.put(
					"href", _getAddChildCollectionURLTemplate()
				).put(
