...
public class AcceptLanguageProviderTest {
	...
	public void setUp() throws Exception {
		...
		_user = UserLocalServiceUtil.addUser(
			...
			null, _USER_DEFAULT_LOCALE, StringUtil.randomString(20), null,
	...
	public void testCreateContextWithNoAcceptLanguageNoGuestUser() {
		...
		Assert.assertEquals(_USER_DEFAULT_LOCALE, locale);
	}

	private static final String _SITE_NAME =
		AcceptLanguageProviderTest.class.getSimpleName() + "Site";

	private static final Locale _USER_DEFAULT_LOCALE = Locale.ITALY;
