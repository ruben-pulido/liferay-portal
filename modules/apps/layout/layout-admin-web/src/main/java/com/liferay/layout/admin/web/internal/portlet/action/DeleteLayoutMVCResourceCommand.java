...
@Component(
	property = {
		...
		"mvc.command.name=/layout_admin/delete_layout_2"
	},
	service = MVCResourceCommand.class
)
public class DeleteLayoutMVCResourceCommand extends BaseMVCResourceCommand {
	...
	protected void doServeResource(
		...
		_deleteLayout(selPlid, resourceRequest, resourceResponse);

		JSONPortletResponseUtil.writeJSON(
			resourceRequest, resourceResponse,
			JSONUtil.put(
				"redirect", ParamUtil.getString(resourceRequest, "redirect")));
	}

	private void _deleteLayout(
			long selPlid, ResourceRequest resourceRequest,
		...
		long layoutSetBranchId = ParamUtil.getLong(
			resourceRequest, "layoutSetBranchId");
		...
		try {
			...
			if (throwable instanceof
				...
				SessionErrors.add(resourceRequest, throwable.getClass());
			}
			else {
				throw exception;
			}
