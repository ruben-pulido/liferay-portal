...
public class ContentLayoutTestUtil {
	...
	public static String getRenderLayoutHTML(
		...
		Group group, LayoutDisplayPageObjectProvider<Object> layoutDisplayPageObjectProvider,
		LayoutServiceContextHelper layoutServiceContextHelper,
		LayoutStructureProvider layoutStructureProvider) throws Exception {
		...
		long segmentsExperienceId = SegmentsExperienceLocalServiceUtil.
			fetchDefaultSegmentsExperienceId(layout.getPlid());
