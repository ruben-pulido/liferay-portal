...
import com.liferay.layout.page.template.admin.web.internal.exporter.LayoutPageTemplatesExportHelper;
...
public class ExportLayoutPageTemplateEntriesMVCResourceCommand
	...
	public File getFile(long[] layoutPageTemplateEntryIds)
		...
		try {
			...
			return _layoutPageTemplatesExportHelper.exportPageTemplates(
	...
	@Reference
	private LayoutPageTemplatesExportHelper _layoutPageTemplatesExportHelper;
