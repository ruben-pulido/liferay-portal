...
import com.liferay.layout.page.template.admin.web.internal.exception.PageTemplateCollectionValidatorException;
...
public class PageTemplateCollectionValidator {
	...
	public static void validatePageTemplateCollection(
		...
		InputStream pageTemplateCollectionJSONSchemaInputStream =
		...
		try {
			JSONValidator.validate(
				...
				pageTemplateCollectionJSONSchemaInputStream);
		}
