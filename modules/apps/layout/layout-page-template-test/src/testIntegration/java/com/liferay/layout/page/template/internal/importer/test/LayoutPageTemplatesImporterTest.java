...
public class LayoutPageTemplatesImporterTest {
	...
	private LayoutPageTemplateEntry _getImportLayoutPageTemplateEntry(
		...
		Assert.assertNotNull(layoutPageTemplateImportEntries);

		Assert.assertEquals(
			layoutPageTemplateImportEntries.toString(), 1,
			layoutPageTemplateImportEntries.size());

		LayoutPageTemplateImportEntry layoutPageTemplateImportEntry =
			layoutPageTemplateImportEntries.get(0);
