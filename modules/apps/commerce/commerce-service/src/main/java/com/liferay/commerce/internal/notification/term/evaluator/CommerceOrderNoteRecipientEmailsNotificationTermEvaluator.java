 ...
 */
public class CommerceOrderNoteRecipientEmailsNotificationTermEvaluator
	implements NotificationTermEvaluator {

	public CommerceOrderNoteRecipientEmailsNotificationTermEvaluator(
	...
	public String evaluate(Context context, Object object, String termName)
		...
		if (!(object instanceof Map) ||
			!termName.equals("[%COMMERCEORDERNOTE_RECIPIENT_EMAILS%]") ||
		...
		return TransformUtil.transform(
			...
			accountEntryUserRel -> {
				...
				if (_accountRoleLocalService.hasUserAccountRole(
					...
					return accountEntryUserRelUser.getEmailAddress();
				}
	...
	private List<String> _getEmailAddresses(Map<String, Object> termValues)
		...
		if (commerceOrderNote.isRestricted() ||
			...
			return Collections.singletonList(
				commerceOrderUser.getEmailAddress());
		}
