...
public class FragmentCollectionItemSelectorView
	...
	public String getTitle(Locale locale) {
		return "Testing fragments"; // TODO replace with real group name
	}

	@Override
	public boolean isVisible(
		FragmentCollectionItemSelectorCriterion itemSelectorCriterion,
		ThemeDisplay themeDisplay) {

		return true; // TODO replace checking if there are fragments
	}
