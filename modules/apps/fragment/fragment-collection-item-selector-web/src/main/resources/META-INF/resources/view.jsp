									...
									>
										<liferay-ui:search-container-column-text>
												<clay:navigation-card
													navigationCard="<%= new FragmentCollectionNavigationCard(fragmentCollection, fragmentCollectionItemSelectorDisplayContext.getFragmentCollectionItemSelectorCriterion()) %>"
												/>
						...
						<clay:container-fluid>
								...
								>
									...
									>
										<liferay-ui:search-container-column-text>
											<clay:navigation-card
												navigationCard="<%= new FragmentCollectionContributorNavigationCard(fragmentCollectionContributor, fragmentCollectionItemSelectorDisplayContext.getFragmentCollectionItemSelectorCriterion()) %>"
											/>
										</liferay-ui:search-container-column-text>
									</liferay-ui:search-container-row>
