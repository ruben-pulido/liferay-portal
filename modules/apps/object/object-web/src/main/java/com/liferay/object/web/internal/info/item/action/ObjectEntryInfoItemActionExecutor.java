...
public class ObjectEntryInfoItemActionExecutor
	...
	public void executeInfoItemAction(
		...
		try {
			...
			String actionName = fieldId;

			if (actionName.startsWith("ObjectAction_")) {
				actionName = actionName.substring("ObjectAction_".length());
			}
			...
			defaultObjectEntryManager.executeObjectAction(
				defaultDTOConverterContext, actionName, _objectDefinition,
