...
public class ManageFriendsViewMVCRenderCommand
	...
	public String render(
		...
		renderRequest.setAttribute(
			...
			HashMapBuilder.<String, Object>put(
				"actionUrl", _getManageFriendsActionURL(renderResponse)
			).put(
				"friends",
	...
	private String _getManageFriendsActionURL(
		RenderResponse renderResponse) {

		PortletURL manageFriendsURL = renderResponse.createActionURL();

		manageFriendsURL.setParameter(
			ActionRequest.ACTION_NAME, "/chess/manage_friends");

		return manageFriendsURL.toString();
	}
