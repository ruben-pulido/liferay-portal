...
/**
 * The arguments resolver class for retrieving value from ChessGame.
 *
 * @author Rubén Pulido
 * @generated
 */
...
public class ChessGameModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		ChessGameModelImpl chessGameModelImpl = (ChessGameModelImpl)baseModel;
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= chessGameModelImpl.getColumnBitmask(
					columnName);
			}

			if (finderPath.isBaseModelResult() &&
				(ChessGamePersistenceImpl.
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				arguments[i] = chessGameModelImpl.getColumnValue(columnName);
			}
		}
