...
public class ChessGameModelIndexerWriterContributor
	...
	public void customize(
		...
		batchIndexingActionable.setPerformActionMethod(
			(ChessGame chessGame) -> batchIndexingActionable.addDocuments(
				modelIndexerWriterDocumentHelper.getDocument(chessGame)));
	}
	...
	public BatchIndexingActionable getBatchIndexingActionable() {
		return dynamicQueryBatchIndexingActionableFactory.
			getBatchIndexingActionable(
				chessGameLocalService.getIndexableActionableDynamicQuery());
	}
