...
public class ChessGamePersistenceImpl
	...
	public void cacheResult(ChessGame chessGame) {
		entityCache.putResult(
			entityCacheEnabled, ChessGameImpl.class, chessGame.getPrimaryKey(),
			chessGame);
	...
	public void cacheResult(List<ChessGame> chessGames) {
		for (ChessGame chessGame : chessGames) {
			if (entityCache.getResult(
					entityCacheEnabled, ChessGameImpl.class,
					chessGame.getPrimaryKey()) == null) {
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, ChessGameImpl.class, primaryKey);
		}
	}
	...
	public void activate() {
		ChessGameModelImpl.setEntityCacheEnabled(entityCacheEnabled);
		ChessGameModelImpl.setFinderCacheEnabled(finderCacheEnabled);

		_finderPathWithPaginationFindAll = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, ChessGameImpl.class,
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.liferay.chess.model.ChessGame"),
			true);
	}
