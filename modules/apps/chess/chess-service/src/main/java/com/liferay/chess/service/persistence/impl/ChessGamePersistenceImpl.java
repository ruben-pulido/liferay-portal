...
public class ChessGamePersistenceImpl
	...
	public void clearCache() {
		...
		finderCache.clearCache(ChessGameImpl.class);
	}
	...
	public void clearCache(ChessGame chessGame) {
		entityCache.removeResult(ChessGameImpl.class, chessGame);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, chessGameModelImpl);
	}
	...
	public ChessGame updateImpl(ChessGame chessGame) {
		...
		entityCache.putResult(
			ChessGameImpl.class, chessGameModelImpl, false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new ChessGameModelArgumentsResolver(),
	...
	private static class ChessGameModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			ChessGameModelImpl chessGameModelImpl =
				(ChessGameModelImpl)baseModel;

			long columnBitmask = chessGameModelImpl.getColumnBitmask();
		...
		private static Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = chessGameModelImpl.getColumnOriginalValue(
						columnName);
				}
				else {
					arguments[i] = chessGameModelImpl.getColumnValue(
						columnName);
				}
			}
