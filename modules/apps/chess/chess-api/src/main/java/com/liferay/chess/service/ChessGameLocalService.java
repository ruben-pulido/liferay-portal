...
/**
 * Provides the local service interface for ChessGame. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Rubén Pulido
 * @see ChessGameLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ChessGameLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.chess.service.impl.ChessGameLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the chess game local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ChessGameLocalServiceUtil} if injection and service tracking are not available.
	 */
