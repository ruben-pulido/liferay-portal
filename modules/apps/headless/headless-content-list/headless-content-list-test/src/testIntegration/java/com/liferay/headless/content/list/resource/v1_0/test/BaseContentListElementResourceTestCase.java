...
package com.liferay.headless.content.list.resource.v1_0.test;
...
public abstract class BaseContentListElementResourceTestCase {
	...
	public void setUp() throws Exception {
		...
		_resourceURL = new URL(
			"http://localhost:8080/o/headless-content-list/v1.0");
	}
	...
	protected Page<ContentListElement> invokeGetContentListContentsPage(
		...
		_outputObjectMapper.addMixIn(ContentListElement.class, TypeMixIn.class);
