...
public class ContentListElementResourceTest
	...
	protected void assertValid(BlogPosting blogPosting) {
		...
		if ((blogPosting.getAlternativeHeadline() != null) &&
			...
			(blogPosting.getHasComments() != null) &&
			(blogPosting.getHeadline() != null) &&
			(blogPosting.getId() != null) && (blogPosting.getOrder() != null)) {
	...
	protected void assertValid(Document document) {
		...
		if ((document.getAdaptedImages() != null) &&
			...
			(document.getCategories() != null) &&
			(document.getCategoryIds() != null) &&
	...
	protected boolean equals(
		...
		if (Objects.equals(
			...
			Objects.equals(
				blogPosting1.getCaption(), blogPosting2.getCaption()) &&
			Objects.equals(
	...
	private BlogPosting _addBlogPosting(
		...
		BlogsEntry blogsEntry = BlogsEntryLocalServiceUtil.addEntry(
			...
			new String[0], blogPosting.getCaption(), null, null,
			serviceContext);
