...
public class FragmentResourceTest extends BaseFragmentResourceTestCase {
	...
	public void testPutSiteFragment() throws Exception {
		...
		_testPutSiteFragmentUpdateApprovedModifyDraftAndApproved();
	...
	private void _assertPutSiteFragmentProblemException(
			Fragment fragment, Fragment postFragment, String titleKey)
		throws Exception {

		fragment.setExternalReferenceCode(
			postFragment.getExternalReferenceCode());
		fragment.setKey(postFragment.getKey());
	...
	private void _assertPutSiteFragmentUpdateApprovedAndDraftToDraftProblemException()
		...
		_assertPutSiteFragmentProblemException(
			...
			_postFragment(_randomFragment(true, true)),
			"unpublishing-a-fragment-is-not-supported");
	}
	...
	private void _assertPutSiteFragmentUpdateApprovedAndDraftToEmptyProblemException()
		...
		_assertPutSiteFragmentProblemException(
			_randomFragment(false, false),
			_postFragment(_randomFragment(true, true)),
			"at-least-one-fragment-version-is-required");
	}
	...
	private void _assertPutSiteFragmentUpdateApprovedToDraftProblemException()
		...
		_assertPutSiteFragmentProblemException(
			_randomFragment(false, true),
			_postFragment(_randomFragment(true, false)),
			"unpublishing-a-fragment-is-not-supported");
	}
	...
	private void _assertPutSiteFragmentUpdateDraftToEmptyProblemException()
		...
		_assertPutSiteFragmentProblemException(
			_randomFragment(false, false),
			_postFragment(_randomFragment(false, true)),
			"at-least-one-fragment-version-is-required");
	}
	...
	private Fragment _randomFragment(boolean approved, boolean draft)
		...
		return _randomFragment(approved, draft, null);
	}
	...
	private void _testPutFragment(Fragment fragment, Fragment postFragment)
		throws Exception {
	...
	private void _testPutSiteFragmentCreateApproved() throws Exception {
		String fragmentExternalReferenceCode = RandomTestUtil.randomString();

		_testPutFragment(
			fragmentExternalReferenceCode,
			_randomFragment(true, false, fragmentExternalReferenceCode));
	}
	...
	private void _testPutSiteFragmentCreateApprovedAndDraft() throws Exception {
		...
		_testPutFragment(
			fragmentExternalReferenceCode,
			_randomFragment(true, true, fragmentExternalReferenceCode));
	}
	...
	private void _testPutSiteFragmentCreateDraft() throws Exception {
		...
		_testPutFragment(
			fragmentExternalReferenceCode,
			_randomFragment(false, true, fragmentExternalReferenceCode));
	}
	...
	private void _testPutSiteFragmentCreateEmpty() throws Exception {
		...
		Fragment fragment = _randomFragment(
			false, false, externalReferenceCode);
	...
	private void _testPutSiteFragmentUpdateApprovedAddDraft() throws Exception {
		...
		_testPutFragment(fragment, postFragment);
	}
	...
	private void _testPutSiteFragmentUpdateApprovedModifyDraftAndApproved()
		throws Exception {
