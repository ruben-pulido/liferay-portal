...
public class FragmentDTOConverter
	...
	public Fragment toDTO(
		...
		FragmentEntry publishedFragmentEntry = _fetchPublishedFragmentEntry(
			fragmentEntry);

		if (publishedFragmentEntry != null) {
			return _toFragment(publishedFragmentEntry);
		}

		return _toFragment(fragmentEntry);
	}

	private FragmentEntry _fetchPublishedFragmentEntry(
		FragmentEntry fragmentEntry) {
