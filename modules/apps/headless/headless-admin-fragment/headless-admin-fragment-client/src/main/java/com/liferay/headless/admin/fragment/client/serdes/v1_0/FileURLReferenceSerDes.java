...
public class FileURLReferenceSerDes {
	...
	public static String toJSON(FileURLReference fileURLReference) {
		...
		if (fileURLReference.getExternalReferenceCode() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(fileURLReference.getExternalReferenceCode()));
	...
	public static Map<String, String> toMap(FileURLReference fileURLReference) {
		...
		if (fileURLReference.getExternalReferenceCode() == null) {
			...
			map.put(
				...
				String.valueOf(fileURLReference.getExternalReferenceCode()));
		}
...
// LIFERAY-REST-BUILDER-HASH:-1342764610