...
@Generated("")
@GraphQLName(
	description = "A resource folder within a fragment set.",
...
public class ResourceFolder implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The external reference code of the fragment set this resource folder belongs to."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The external reference code of the parent resource folder. Null when the resource folder is at the fragment set's root."
	)
...
// LIFERAY-REST-BUILDER-HASH:-1900599682