...
public class ContentListElementResourceTest
	...
	@Override
	protected StructuredContent testGetContentListElementsOfTypeStructuredContentPage_addStructuredContent(
	...
	protected StructuredContent toStructuredContent(
		...
		Class<? extends AssetListElementResource> clazz =
			_assetListElementResource.getClass();

		Method method = clazz.getDeclaredMethod(
			"_toStructuredContent", JournalArticle.class);

		method.setAccessible(true);

		return (StructuredContent) method.invoke(
			_assetListElementResource, journalArticle);
	}
	...
	@Inject
	private AssetListElementResource _assetListElementResource;
