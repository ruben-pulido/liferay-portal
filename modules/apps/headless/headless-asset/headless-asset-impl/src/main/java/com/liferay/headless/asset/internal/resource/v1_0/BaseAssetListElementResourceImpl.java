 ...
 */
@Path("/v1.0")
public class BaseAssetListElementResourceImpl
	implements AssetListElementResource {
	...
	protected String getJAXRSLink(String methodName, Object... values) {
		...
		URI resourceURI = UriBuilder.fromResource(
			BaseAssetListElementResourceImpl.class
		).build();

		URI methodURI = UriBuilder.fromMethod(
			BaseAssetListElementResourceImpl.class, methodName
		).build(
			values
		);
