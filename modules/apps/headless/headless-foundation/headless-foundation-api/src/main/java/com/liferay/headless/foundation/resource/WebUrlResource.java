...
import com.liferay.headless.foundation.dto.WebUrlCollection;
 ...
 *
 *     curl -u your@email.com:yourpassword -D - http://localhost:8080/o/headless-foundation/1.0.0/web-url
 *
...
public interface WebUrlResource {
	...
	public WebUrlCollection<WebUrl> getWebUrlCollection(
