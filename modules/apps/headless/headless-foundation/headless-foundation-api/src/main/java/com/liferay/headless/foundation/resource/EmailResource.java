...
import com.liferay.headless.foundation.dto.EmailCollection;
 ...
 *
 *     curl -u your@email.com:yourpassword -D - http://localhost:8080/o/headless-foundation/1.0.0/email
 *
...
public interface EmailResource {
	...
	public EmailCollection<Email> getEmailCollection(
