...
public class MappedValueSerDes {
	...
	public static String toJSON(MappedValue mappedValue) {
		...
		if (mappedValue.getDefaultValue() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(String.valueOf(mappedValue.getDefaultValue()));
		}

		if (mappedValue.getMapping() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(String.valueOf(mappedValue.getMapping()));
		}
	...
	public static Map<String, String> toMap(MappedValue mappedValue) {
		...
		if (mappedValue.getDefaultValue() == null) {
			...
			map.put(
				"defaultValue", String.valueOf(mappedValue.getDefaultValue()));
		}
		...
		if (mappedValue.getMapping() == null) {
			...
			map.put("mapping", String.valueOf(mappedValue.getMapping()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "defaultValue")) {
				if (jsonParserFieldValue != null) {
					mappedValue.setDefaultValue(
						InlineValueSerDes.toDTO((String)jsonParserFieldValue));
				}
			}
			else if (Objects.equals(jsonParserFieldName, "mapping")) {
				if (jsonParserFieldValue != null) {
					mappedValue.setMapping(
