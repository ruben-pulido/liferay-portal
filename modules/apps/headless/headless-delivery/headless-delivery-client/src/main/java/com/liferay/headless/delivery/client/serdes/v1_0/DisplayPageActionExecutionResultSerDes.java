...
public class DisplayPageActionExecutionResultSerDes {
	...
	public static String toJSON(
		...
		if (displayPageActionExecutionResult.getItemReference() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				String.valueOf(
					displayPageActionExecutionResult.getItemReference()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "itemReference")) {
				if (jsonParserFieldValue != null) {
					displayPageActionExecutionResult.setItemReference(
