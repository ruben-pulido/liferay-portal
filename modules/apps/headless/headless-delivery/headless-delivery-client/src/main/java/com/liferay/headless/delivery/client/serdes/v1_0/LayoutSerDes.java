...
public class LayoutSerDes {
	...
	public static String toJSON(Layout layout) {
		...
		if (layout.getContainerWidth() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(layout.getContainerWidth());
	...
	public static Map<String, String> toMap(Layout layout) {
		...
		if (layout.getContainerWidth() == null) {
			map.put("containerWidth", null);
		}
		else {
			map.put(
				"containerWidth", String.valueOf(layout.getContainerWidth()));
		}
	...
	public static class LayoutJSONParser extends BaseJSONParser<Layout> {
		...
		protected void setField(
			...
			else if (Objects.equals(jsonParserFieldName, "containerWidth")) {
				if (jsonParserFieldValue != null) {
					layout.setContainerWidth(
						Layout.ContainerWidth.create(
							(String)jsonParserFieldValue));
				}
			}
