...
public class Layout {
	...
	@Schema
	@Valid
	public ContainerWidth getContainerWidth() {
		return containerWidth;
	}

	@JsonIgnore
	public String getContainerWidthAsString() {
		if (containerWidth == null) {
			return null;
		}

		return containerWidth.toString();
	}

	public void setContainerWidth(ContainerWidth containerWidth) {
		this.containerWidth = containerWidth;
	}

	@JsonIgnore
	public void setContainerWidth(
		UnsafeSupplier<ContainerWidth, Exception>
			containerWidthUnsafeSupplier) {

		try {
			containerWidth = containerWidthUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected ContainerWidth containerWidth;
	...
	@GraphQLName("ContainerWidth")
	public static enum ContainerWidth {

		FIXED("Fixed"), FLUID("Fluid");

		@JsonCreator
		public static ContainerWidth create(String value) {
			for (ContainerWidth containerWidth : values()) {
				if (Objects.equals(containerWidth.getValue(), value)) {
					return containerWidth;
				}
			}
		...
		private ContainerWidth(String value) {
			_value = value;
		}
