...
package com.liferay.headless.sites.internal.resource.v1_0;

import com.liferay.headless.common.spi.service.context.ServiceContextRequestUtil;
import com.liferay.headless.sites.dto.v1_0.Site;
import com.liferay.headless.sites.resource.v1_0.SiteResource;
...
public class SiteResourceImpl extends BaseSiteResourceImpl {
	...
	private Group _updateGroup(Site site) throws Exception {
...
//				WebKeys.THEME_DISPLAY);
		...
		if (site.getParentSiteId() != null) {
			parentGroupId = site.getParentSiteId();
		}
		...
		if (membershipType != null) {
			...
			if (value.equals(GroupConstants.TYPE_SITE_RESTRICTED_LABEL)) {
...
//		}
		...
		int trashEntriesMaxAgeCompany = PrefsPropsUtil.getInteger(
			CompanyThreadLocal.getCompanyId(), PropsKeys.TRASH_ENTRIES_MAX_AGE);

		int trashEntriesMaxAgeGroup = 0;
...
//			creationType.equals("CREATION_TYPE_SITE_TEMPLATE")) {
//			_updateGroupFromSiteTemplate(actionRequest, liveGroup);
//		}
//		else if (creationType.equals("CREATION_TYPE_INITIALIZER")) {
