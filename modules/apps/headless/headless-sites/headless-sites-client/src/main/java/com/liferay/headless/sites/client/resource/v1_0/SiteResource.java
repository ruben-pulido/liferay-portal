...
package com.liferay.headless.sites.client.resource.v1_0;

import com.liferay.headless.sites.client.dto.v1_0.Site;
import com.liferay.headless.sites.client.http.HttpInvoker;
import com.liferay.headless.sites.client.problem.Problem;
...
public interface SiteResource {
	...
	public static class SiteResourceImpl implements SiteResource {
		...
		public Site postSite(Site site) throws Exception {
			...
			try {
				return com.liferay.headless.sites.client.serdes.v1_0.SiteSerDes.
					toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
