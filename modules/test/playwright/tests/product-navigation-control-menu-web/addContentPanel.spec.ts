...
import getBasicWebContentStructureId from '../../utils/getBasicWebContentStructureId';
import getRandomId from '../../utils/getRandomId';
import {widgetPagesTest} from './fixtures/widgetPagesTest';
import addApprovedStructuredContent from './utils/addApprovedStructuredContent';
import addDraftStructuredContent from './utils/addDraftStructuredContent';
import addExpiredStructuredContent from './utils/addExpiredStructuredContent';
import addInTrashStructuredContent from './utils/addInTrashStructuredContent';
import addScheduledStructuredContent from './utils/addScheduledStructuredContent';

export const test = mergeTests(apiHelpersTest, loginTest, widgetPagesTest);

test('LPD-15256 Only approved and scheduled web contents should be displayed in the Content tab of the Add panel of a widget page', async ({
	apiHelpers,
	page,
	widgetPage,
}) => {
	...
	const inTrashWebContentTitle = 'Web Content in Trash';
