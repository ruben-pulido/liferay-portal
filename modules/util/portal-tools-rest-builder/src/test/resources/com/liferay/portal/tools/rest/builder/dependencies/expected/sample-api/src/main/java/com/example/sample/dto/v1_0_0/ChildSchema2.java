 ...
 */
@Generated("")
@GraphQLName("ChildSchema2")
@JsonFilter("Liferay.Vulcan")
@JsonTypeInfo(
	defaultImpl = ChildSchema2.class, include = JsonTypeInfo.As.PROPERTY,
	property = "childType", use = JsonTypeInfo.Id.NAME
)
@XmlRootElement(name = "ChildSchema2")
public class ChildSchema2 extends PolymorphicSchema implements Serializable {

	public static ChildSchema2 toDTO(String json) {
		return ObjectMapperUtil.readValue(ChildSchema2.class, json);
	}

	public static ChildSchema2 unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ChildSchema2.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.example.sample.dto.v1_0_0.ChildSchema2",
		name = "x-class-name"
	)
