 ...
 */
@Generated("")
@GraphQLName("InvitedMemberBrief")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "InvitedMemberBrief")
public class InvitedMemberBrief implements Serializable {

	public static InvitedMemberBrief toDTO(String json) {
		return ObjectMapperUtil.readValue(InvitedMemberBrief.class, json);
	}

	public static InvitedMemberBrief unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(InvitedMemberBrief.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.digital.sales.room.dto.v1_0.InvitedMemberBrief",
		name = "x-class-name"
	)
